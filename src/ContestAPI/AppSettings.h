...
// Preferred TriTone editor res
// #define APP_VIRTUAL_WIDTH		(1900)                      // This will be the effective x resolution regardless of actual screen/window res.
...
#define APP_ENABLE_DEBUG_INFO_BUTTON		(App::BTN_DPAD_LEFT)
// #define APP_QUIT_KEY						(App::KEY_L)
