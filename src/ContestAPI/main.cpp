...
// FIX: only the first index was initialized.
// Increased size because mouse wheel events also index into this array!!
int gMouseButtonState[5] = { GLUT_UP, GLUT_UP, GLUT_UP, GLUT_UP, GLUT_UP };
