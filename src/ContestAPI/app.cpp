...
#define HANDLE_SPECIAL_KEY(KEYCODE, SPECIAL_KEY) \
		...
		switch (key)
		{
			...
			HANDLE_ASCII_SPECIAL_KEY(KEY_BACKSPACE, '\b')

			HANDLE_ASCII_SPECIAL_KEY(KEY_CTRL_A, 1)
			HANDLE_ASCII_SPECIAL_KEY(KEY_CTRL_B, 2)
			HANDLE_ASCII_SPECIAL_KEY(KEY_CTRL_C, 3)
			HANDLE_ASCII_SPECIAL_KEY(KEY_CTRL_D, 4)
			HANDLE_ASCII_SPECIAL_KEY(KEY_CTRL_E, 5)
			HANDLE_ASCII_SPECIAL_KEY(KEY_CTRL_F, 6)
			HANDLE_ASCII_SPECIAL_KEY(KEY_CTRL_G, 7)
			HANDLE_ASCII_SPECIAL_KEY(KEY_CTRL_H, 8)
			HANDLE_ASCII_SPECIAL_KEY(KEY_CTRL_I, 9)
			HANDLE_ASCII_SPECIAL_KEY(KEY_CTRL_J, 10)
			HANDLE_ASCII_SPECIAL_KEY(KEY_CTRL_K, 11)
			HANDLE_ASCII_SPECIAL_KEY(KEY_CTRL_L, 12)
			HANDLE_ASCII_SPECIAL_KEY(KEY_CTRL_M, 13)
			HANDLE_ASCII_SPECIAL_KEY(KEY_CTRL_N, 14)
			HANDLE_ASCII_SPECIAL_KEY(KEY_CTRL_O, 15)
			HANDLE_ASCII_SPECIAL_KEY(KEY_CTRL_P, 16)
			HANDLE_ASCII_SPECIAL_KEY(KEY_CTRL_Q, 17)
			HANDLE_ASCII_SPECIAL_KEY(KEY_CTRL_R, 18)
			HANDLE_ASCII_SPECIAL_KEY(KEY_CTRL_S, 19)
			HANDLE_ASCII_SPECIAL_KEY(KEY_CTRL_T, 20)
			HANDLE_ASCII_SPECIAL_KEY(KEY_CTRL_U, 21)
			HANDLE_ASCII_SPECIAL_KEY(KEY_CTRL_V, 22)
			HANDLE_ASCII_SPECIAL_KEY(KEY_CTRL_W, 23)
			HANDLE_ASCII_SPECIAL_KEY(KEY_CTRL_X, 24)
			HANDLE_ASCII_SPECIAL_KEY(KEY_CTRL_Y, 25)
			HANDLE_ASCII_SPECIAL_KEY(KEY_CTRL_Z, 26)

			HANDLE_SPECIAL_KEY(KEY_LSHIFT, 112)
			HANDLE_SPECIAL_KEY(KEY_RSHIFT, 113)
			HANDLE_SPECIAL_KEY(KEY_CTRL, 114)
